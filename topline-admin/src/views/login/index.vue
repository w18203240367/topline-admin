  ...
  <div class="login-wrap">
    <div class="form-wrap">
      ...
      <el-form ref="form" :model="form" :rules="rules">
        <!--
          配置校验：
            rules 规则对象配置到 el-form rules 中配置的校验字段必须和表单数据对象保持一致
            prop 配置到 el-form-item
          JS触发验证
            给 el-form 添加ref
...
import { saveUser } from '@/utils/auth' // 按需加载 加载模块中 非export default 成员
    ...
    return {
      ...
      rules: {
        mobile: [
          ...
          // { len: 11, message: '长度在 11个字符', trigger: 'blur' }
